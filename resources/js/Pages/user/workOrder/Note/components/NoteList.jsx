...
const NoteList = ({ id, details, addNote, setAddNote, onSuccessMessage, onErrorMessage, is_cancelled, is_billing }) => {
    const timezone = 'CT'
    const timezoneMap = {
    ...
    return (
        <div className='mt-4 d-flex gap-4'>
            <div>
                ...
                <button className='text-primary border-0 bg-transparent' style={{ fontSize: '12px', whiteSpace: 'nowrap', cursor: 'pointer' }} onClick={() => setAddNote(addNote ? null : details.id)} disabled={is_cancelled || is_billing}>+ Add Note</button>
            </div>
            <div className='w-100'>
