    ...
    return (
        <div className="card bg-white shadow border-0 mb-4">
            ...
            <div className="card-body bg-white">
                <ShipmentTable details={details} onSuccessMessage={onSuccessMessage} is_cancelled={is_cancelled} is_billing={is_billing}/>
                ...
                }
                {
                    ...
                    <div className="w-100 py-3">
                        <button type="button" onClick={() => setAddShipment(true)} className="btn btn-outline-dark addShipment" disabled={is_cancelled || is_billing}>+ Add
                            Shipment</button>
                    </div>
                }
