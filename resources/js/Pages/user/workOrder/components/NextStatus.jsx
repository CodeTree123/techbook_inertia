...
const NextStatus = ({id, onSuccessMessage, onErrorMessage, status, is_ftech, is_cancelled, is_billing}) => {
    ...
    return (
        <>
            <form onSubmit={submit}>
                <Button variant='outline-primary' type="submit" disabled={status == 15 || is_cancelled || is_billing}
                >
                    Next
                </Button>
            </form>
