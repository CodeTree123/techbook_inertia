...
const AddHold = ({ id, stage, onSuccessMessage, is_cancelled, is_billing }) => {
    ...
    return (
        <>
            <Button variant="outline-dark" style={{height: 'max-content'}} onClick={handleShowHold} disabled={is_cancelled || is_billing}>
