...
const ChangePassword = () => {
    ...
    return (
        <MainLayout>
            <Head>
                <title>Change Password | Techbook</title>
            </Head>
                    ...
                    <div className="card-body">
                        <div className='row'>
                            <div className='col-md-6 mb-3'>
                                <label htmlFor="" className='mb-1'>Current Password</label>
                                <input type="password" placeholder='Current Password' className='w-100 border px-3 py-2' onChange={(e) => setData({ ...data, current_password: e.target.value })} />
