        ...
        <MainLayout>
            ...
            <div className='container-fluid total-bg'>
                <div className='bg-white border rounded py-3 px-1 row justify-content-between align-items-center mt-3 mb-3'>
                    <h2 class="fs-4 mb-0 col-md-2">New Work Order ({type == 1 ? 'Service' : type == 2 ? 'Project' : type == 3 ? 'Install' : ''})</h2>
                ...
                <div className='row justify-content-between align-items-start mt-3'>
                    <div className='w-25 ps-0 pe-3 mb-3 '>
                        <div className='bg-white border rounded'>
                            <ul>
                                ...
                                <li className='fw-bold py-3 text-center border-bottom' style={{ cursor: 'pointer' }}>Technician Provided Parts</li>
                                <li className='fw-bold py-3 text-center border-bottom' style={{ cursor: 'pointer' }}>Shipments</li>
                                <li className='fw-bold py-3 text-center border-bottom' style={{ cursor: 'pointer' }}>Documents For Technicians</li>
                                <li className='fw-bold py-3 text-center border-bottom' style={{ cursor: 'pointer' }}>Dispatch Instructions</li>
