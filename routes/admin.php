...
Route::namespace('Auth')->group(function () {
    ...
    Route::controller('RegisterController')->group(function () {
        Route::get('/register', 'showRegisterForm')->name('register')->middleware('validate.admin.invitation');
        Route::post('/token/post', 'verifyToken')->name('token');
        Route::post('/register/post', 'register')->name('postRegister')->middleware('validate.admin.invitation');
        Route::get('/verify/user/reg', 'showVerifierForm')->name('verify.view');
    });
...
Route::middleware('admin')->group(function () {
    Route::controller('AdminController')->group(function () {
        Route::get('/dashboard', 'dashboard')->name('dashboard')->middleware('adminRole');
        Route::get('/dashboard/new', 'dashboardNew')->name('dashboardNew');
        Route::get('profile', 'profile')->name('profile');
        Route::post('update/profile', 'profileUpdate')->name('profile.update');
        Route::get('password', 'password')->name('password');
        Route::post('update/password', 'passwordUpdate')->name('password.update');
    ...
    Route::controller('ManageUsersController')->name('users.')->prefix('users.')->group(function () {
        ...
        Route::get('send-notification/{id}', 'showNotificationSingleForm')->name('notification.single.get');
    ...
    Route::controller('SupportTicketController')->prefix('ticket')->name('ticket.')->group(function () {
        ...
        Route::get('assign', 'assignTicket')->name('assign');
    ...
    //item 
    Route::controller('ItemController')->prefix('item')->name('item.')
        ->group(function () {
            Route::get('/', 'item')->name('index');
            Route::get('store/item', 'itemStore')->name('store');
        });
    ...
    Route::controller('GeneralSettingController')->group(function () {
        ...
        // Logo-Icon
        Route::get('setting/logo-icon', 'logoIcon')->name('setting.logo.icon.get');
    ...
    Route::controller('SubscriberController')->prefix('subscriber')->name('subscriber.')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::get('send-email', 'sendEmailForm')->name('send.email.get');
    ...
    Route::controller('InvoiceController')->group(function () {
        ...
        Route::post('update-invoice-site_num/{id}', 'updateSiteNumber')->name('invoice.updateSiteNumber');
